...
from app import db
from app.main.forms import EditProfileForm, PostForm, LandingForm, UploadReceiptForm
...
def user(username):
    ...
    user.total_points = user.get_total_collect()
    #user.monthly_points = user.get_monthly_collect()
    page = request.args.get('page', 1, type=int)
